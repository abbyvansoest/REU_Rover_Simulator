...
// 			std::cout << "BEGIN: " << sim->getReward() << "\tSTEPS: " << sim->getSteps() << std::endl;
// 		}
...
// 			// if (sim.getSteps() < 10) {
// 			// 	std::cout << "TOO FEW STEPS YO" << std::endl;
// 			// 	sim.reset();
...
int main(void) {
	...
	for (int i = 0; i < NUM_EPOCHS; i++) {
		...
		//std::cout << "LENGTH IS " << simulations.size() << std::endl;
		...
		//if (simulations.size() != NUM_SIMULATIONS) std::cout << "WRONG " << simulations.size() << std::endl;
